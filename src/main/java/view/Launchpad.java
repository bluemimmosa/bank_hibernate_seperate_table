...
//    
    public void createAcc(){
        ...
        sc.nextLine(); // to consume any unwanted carriage return
        System.out.println("Enter Address: ");
        System.out.println("Enter Provience: ");
        this.addr.setProvience(sc.nextLine());
        System.out.println("Enter District: ");
        this.addr.setDistrict(sc.next());
        sc.nextLine();
        System.out.println("Enter Municipality: ");
        this.addr.setMunicipality(sc.next());
        sc.nextLine();
        System.out.println("Enter ward number: ");
        this.addr.setWard(sc.nextInt());
        sc.nextLine();
        ...
        if(ach.createAccount(accountNumber, name, mobileNumber, balance, accountType, ad)){
